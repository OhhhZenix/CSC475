...
fun EditMealLogScreen(
    ...
    LaunchedEffect(Unit) {
        ...
        mealLogDao.getLog(selectedMealLog.intValue).let {
    ...
    Scaffold(topBar = {
        ...
        Column(
            ...
            Text(
                "(Selected Meal Log ID: ${selectedMealLog.intValue})",
            ...
            Button(
                onClick = {
                    coroutineScope.launch {
                        mealLogDao.removeLog(selectedMealLog.intValue)
                    }
                    navController.navigate(AppScreen.MealLog.name)
                },
                modifier = Modifier
